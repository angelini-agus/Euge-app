...
/** Converts an array of strings to PrimeReact Dropdown option format */
...
export default function NuevaConsulta() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.current.show({
        severity: 'success',
        summary:  '¡Lead guardado!',
        detail:   `La consulta de ${form.nombreCliente || 'cliente'} fue registrada correctamente.`,
        life:     3500,
      })
      setForm(EMPTY_FORM)
    } catch (err) {
      const msg = err.response?.data?.error || 'No se pudo guardar. Verificá la conexión con el servidor.'
      toast.current.show({
        severity: 'error',
  ...
  return (
    <>
      ...
      <div style={{
        ...
        alignItems: 'center', gap: '12px', paddingTop: '8px', paddingBottom: '32px'
      }}>
        <button
